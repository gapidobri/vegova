  ...
  <table>
    <tbody>
      <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
          <td class="<?= $razvrsti[0] == "imeKraja" ? "green" : "" ?>"><?= $row['imeKraja'] ?></td>
          <td><?= $row['ime'] ?></td>
          <td class="<?= $razvrsti[0] == "priimek" ? "green" : "" ?>"><?= $row['priimek'] ?></td>
          <td class="<?= $razvrsti[0] == "rojstvo" ? "green" : "" ?>"><?= $row['rojstvo'] ?></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
